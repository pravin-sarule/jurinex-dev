...
$CorsOrigins = "https://ailearn.co.in,https://www.ailearn.co.in,http://localhost:5173,http://localhost:3000,http://localhost:5000"
...
gcloud run deploy $ServiceName `
  ...
  --min-instances 0 `
  --max-instances 10 `
  --update-env-vars "CORS_ORIGINS=$CorsOrigins,GUNICORN_TIMEOUT=$GunicornTimeout,WEB_CONCURRENCY=1"
