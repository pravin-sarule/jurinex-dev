def issue_extraction_prompt(query: str, case_context: str, perspective: str) -> str:
    ...
    return (
        ...
        "DOCTRINE CHECKLIST — screen EVERY issue against ALL of these and list any that apply "
        "in doctrines[]:\n"
        "1. Article 14 arbitrariness (Tata Cellular line)\n"
        "2. Scope of judicial review of tender decisions (Wednesbury unreasonableness)\n"
        "3. Legitimate expectation (oral/written assurance acted upon)\n"
        "4. Promissory estoppel against the State\n"
        "5. Authority cannot take advantage of its own wrong\n"
        "6. Level playing field in public procurement\n"
        "7. Essential vs ancillary conditions / substantial compliance\n"
